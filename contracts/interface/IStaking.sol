...
interface IStaking {
    ...
    event StakingTokenUpdated(address newTokenAddress);
    ...
    */
    ...
    /**
        @dev update staking tokens from the contract
        @param newTokenAddress  address of the token to be staked instead
    */
