...
interface ICore {
    ...
    event CreatedCrestFiWallet(address indexed owner);
    ...
    event CreatedCrestFiWalletAndStreamed(
        address indexed crestFiWallet,
    ...
    */
    ...
    /**
        ...
        @param crestFiWalletWithdraw  option to withdraw in the crest wallet 
     */
    ...
    /**
        ...
        @param crestFiWallet   address in which to deposit 
    ...
    /**
        ...
        @param CrestFiWalletWithdrawn is crest wallet withdraw
    */
    ...
    /**
        ...
        @param crestFiWalletWithdraw  address to transfer to 
    */
     ...
     * @param crestFiWalletWithdraw  withdraw in wallet
     */
     ...
     * @param transferReceiver     stream receiver
     * @param proofs               proof
     * @param crestFiWalletWithdraw  is crest wallet withdraw
     */
